...
class Helpers():
    ...
    def __init__(self):
        ...
        self.refuting_words = set(['fake','fraud', 'hoax', 'false', 'deny', 'denies', 'despite', 'nope', 'doubt', 'bogus', 'debunk', 'prank', 'retract', 'scam'])
        self.refuting_words_stemmed = set(['fake','fraud', 'hoax', 'fals', 'deni', 'despit', 'nope', 'doubt', 'bogu', 'debunk', 'prank', 'retract', 'scam'])
        ...
        self.pos_short = ["C","D","E","F","I","J","L","M","N","P","R","S","T","U","V","W"]
